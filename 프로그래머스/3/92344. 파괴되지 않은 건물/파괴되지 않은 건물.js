function solution(board, skill) {
    ...
    skill
        .map(([type, r1, c1, r2, c2, absoluteDegree]) => [r1, c1, r2, c2, type === 1 ? -absoluteDegree : absoluteDegree])
    ...
    return board.map((row, r) => row.map((value, c) => value + prefixSum[r][c] > 0 ? 1 : 0).reduce(sum, 0)).reduce(sum, 0);
}
