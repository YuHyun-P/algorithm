function solution(board, aloc, bloc) {
    ...
    const play = (player, [playerR, playerC], opponentLoc, nMove, board) => {
        ...
        direction.forEach(([dr, dc]) => {
            ...
            const childResult = play(getNextPlayer(player), opponentLoc, [nextR, nextC], nMove + 1, board);
        ...
        return minPlayerWin ? [minPlayerWin, player] : [maxOpponentWin, getNextPlayer(player)];
    };
